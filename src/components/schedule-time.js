    ...
    <Card title="When do you want to check-in with your team members?"
        ...
        <div className="schedule__content">
            ...
            <div className="schedule__weekdays--buttons">
                <a className={schedule.repeat_on['sun'] ? 'weekday weekday--first button-next': 'weekday weekday--first'} 
                   onClick={() => toggleDayRepeat('sun')}>Sun</a>
                <a className={schedule.repeat_on['mon'] ? 'weekday button-next': 'weekday'} 
                   onClick={() => toggleDayRepeat('mon')}>Mon</a>
                <a className={schedule.repeat_on['tue'] ? 'weekday button-next': 'weekday'} 
                   onClick={() => toggleDayRepeat('tue')}>Tue</a>
            </div>
        </div>
        <div className="schedule__weekdays">
        ...
        <div className="schedule__weekdays--buttons weekdays--extended">
            <a className={schedule.repeat_on['wed'] ? 'weekday weekday--first weekday--margin button-next': 'weekday weekday--first weekday--margin'} 
               onClick={() => toggleDayRepeat('wed')}>Wed</a>
            <a className={schedule.repeat_on['thu'] ? 'weekday button-next': 'weekday'} 
               onClick={() => toggleDayRepeat('thu')}>Thu</a>
